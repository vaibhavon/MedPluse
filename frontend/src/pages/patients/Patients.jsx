...
//               <button className="edit" onClick={(e) => { e.stopPropagation(); navigate(`/patients/edit/${p.id}`); }}>Edit</button>
//               <button className="danger" onClick={(e) => { e.stopPropagation(); handleDelete(p.id); }}>Delete</button>
//               <MoreVertical />
//             </div>
//           </div>
//         ))}
